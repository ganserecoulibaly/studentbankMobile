            ...
            Center(
              child: Container(
                  ...
                  decoration: ShapeDecoration(
                      color: Colors.white,
                      shape: RoundedRectangleBorder(
                          side: const BorderSide(width: 2, color: Color(0xFFED174C)),
                          borderRadius: BorderRadius.circular(10),
                      ),
                  ),
                   child: Column(
                              ...
                              child: Row(
                                ...
                                children: [
                                  Container(
                                    ...
                                    child: Text(premon,
                                    style: const TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.pink),
                                    )
                                  ),
                                  Container(
                                    margin: const EdgeInsets.only(left: 5),
                                    child: Text(nom,style: const TextStyle(fontSize: 15,color: Colors.pink),),
                                  ),
                                ],
                              ),
                            ),
