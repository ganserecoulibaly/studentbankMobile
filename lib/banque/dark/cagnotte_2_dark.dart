        ...
        child: ListView(
          children: [
             ...
             Container(
              ...
              alignment: Alignment.center,
              child:const Text("Créer ma cagnotte",style: TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold),),
            ),
             Container(
              // alignment: Alignment.center,
              margin: const EdgeInsets.only(left:20,right: 20,bottom: 5),
             
              child: const Text("Nom de la cagnotte",style: TextStyle(color:Colors.white,fontSize: 16,fontWeight: FontWeight.bold),)
            ),
             Container(
              // alignment: Alignment.center,
              margin: const EdgeInsets.only(left:20,right: 20,bottom: 5),
             ...
             Container(
              ...
              child: const Text("Type de la cagnotte",style: TextStyle(color:Colors.white,fontSize: 16,fontWeight: FontWeight.bold),)
            ),
              Container(
              // alignment: Alignment.center,
              margin: const EdgeInsets.only(left:20,right: 20,bottom: 5),
